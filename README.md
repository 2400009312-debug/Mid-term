...
1. **`index.html`** — Portfolio cá nhân: giới thiệu bản thân, kỹ năng và định hướng nghề nghiệp.
2. **`travel.html`** — Các địa điêm du lich ở tỉnh Champasak, Laos. Miền nam của Laos.
3. **`hotel.html`** — Các khách sạn tiêu biểu tại tỉnh Champasak (chủ yếu ở thị xã Pakse), Laos. Miền nam của Laos.
